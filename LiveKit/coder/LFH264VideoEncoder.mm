...
@property (nonatomic, weak) id<VideoEncodingDelegate> h264Delegate;
...
- (instancetype)initWithVideoStreamConfiguration:(LiveVideoConfiguration *)configuration {
    if (self = [super init]) {
...
- (void)setDelegate:(id<VideoEncodingDelegate>)delegate{
