...
@property (nonatomic, strong) Camera *videoCamera;
//@property (nonatomic, strong) LFGPUImageBeautyFilter *beautyFilter;
//@property (nonatomic, strong) GPUImageOutput<GPUImageInput> *filter;
//@property (nonatomic, strong) GPUImageCropFilter *cropfilter;
//@property (nonatomic, strong) GPUImageOutput<GPUImageInput> *output;
//@property (nonatomic, strong) GPUImageView *gpuImageView;
@property (nonatomic, strong) RenderView *gpuImageView;
@property (nonatomic, strong) LiveVideoConfiguration *configuration;
...
- (instancetype)initWithVideoConfiguration:(LiveVideoConfiguration *)configuration {
    if (self = [super init]) {
...
- (void)setPreviewImageView:(UIView *)previewImageView {
    ...
    [previewImageView insertSubview:self.gpuImageView atIndex:0];
    self.gpuImageView.frame = CGRectMake(0, 0, previewImageView.frame.size.width, previewImageView.frame.size.height);
}
